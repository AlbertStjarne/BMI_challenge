...
// testar om vi ser resultatet från calculator spec eller inte

const { expect } = require('chai');
const BrowserHelpers = require('e2e_training_wheels')
const browser = new BrowserHelpers()

describe('User can calculate BMI using the metric system', () => {
    before(async () => {
        await browser.init()
...
describe('User can calculate BMI using the imperial method', () => {
    ...
    it('by inputing his weight and height', async () => {
        await browser.selectOption("select[id='my_select']", {option: 'imperial'})  // to distinguish that it is imperial method
